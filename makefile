...
bin/anx: bin/anx.o bin/lexer.o bin/ast.o bin/ir.o bin/utils.o | bin
	$(CC) -g -o bin/anx bin/anx.o bin/lexer.o bin/ast.o bin/ir.o bin/utils.o $(CFLAGS) $(LINKERFLAGS) 
