...
bin/anx.o: src/anx.cpp src/anx.h src/frontend/ast.h src/ir.h | bin
...
bin/ir.o : src/ir.cpp src/ir.h src/frontend/ast.h src/anx.h src/opti.h | bin
	$(CC) -g -c -o bin/ir.o src/ir.cpp $(CFLAGS) $(LLVMFLAGS)

bin/utils.o : src/utils.cpp src/ir.h src/frontend/ast.h src/anx.h | bin
